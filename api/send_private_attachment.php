...
$stmt = db()->prepare(
    'INSERT INTO private_messages (conversation_id, sender_id, body, reply_to_id, attachment_type, attachment_path, attachment_name, attachment_size, attachment_duration)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)'
);
$stmt->execute([
    $conversationId,
