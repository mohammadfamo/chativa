...
$groupId = (int) ($_POST['conversation_id'] ?? 0);
...
$stmt = db()->prepare(
    'INSERT INTO group_messages (group_id, sender_id, body, reply_to_id, attachment_type, attachment_path, attachment_name, attachment_size, attachment_duration)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)'
);
$stmt->execute([
    $groupId,
